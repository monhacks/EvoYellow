...
INCLUDE "data/baseStats/swinnub.asm"
...
INCLUDE "data/baseStats/steelix.asm";237
...
;INCLUDE "data/baseStats/megacharizard.asm"
;INCLUDE "data/baseStats/megablastoise.asm"
;INCLUDE "data/baseStats/megavenusaur.asm" ;using dex entries for megas is cheap but easy
